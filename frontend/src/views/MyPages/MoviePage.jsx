...
class MoviePage extends React.Component {
    ...
    editClick = (id) => {
        var link = "http://localhost:8080/movies/" + id;
        console.log(link);
        ...
        return (
            <tr key={a}>
                ...
                <td class="td-actions text-center">
                    <button type="button" rel="tooltip" class="btn btn-info" onClick={() => this.editClick(movie.id)}>
                        <i class="material-icons">edit</i>
                    </button>
                    <button type="button" rel="tooltip" class="btn btn-info" value={movie.id} onClick={() => this.deleteClick(movie.id)}>
...
export default withStyles(loginPageStyle)(MoviePage);
